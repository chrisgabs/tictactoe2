...
<div class="flex flex-col sm:py-24 gap-2 items-center sm:justify-between mx-auto">
    ...
    <button on:click={resetGame} class="btn btn-outline btn-sm w-32  sm:w-12 sm:hidden">New game</button>
    <button on:click={leaveRoom} class="btn btn-outline btn-error w-32 sm:w-min whitespace-nowrap btn-sm">Leave Game</button>
</div>
